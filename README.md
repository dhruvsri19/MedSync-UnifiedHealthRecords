# 🌙 MedSync — Intelligent Web-Based Personal Health Record (AI + Family Health + Safety Tools)
...
Built with **Next.js**, and **AI-driven analysis**, MedSync empowers users to understand their health, track wellness, manage medications, support family members, and access first-aid help — all through a polished, Apple-inspired dark interface.
